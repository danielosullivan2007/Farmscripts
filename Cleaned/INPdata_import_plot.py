...
match2_locations = match2.locations
match2_locations = match2.as_matrix()


lowruns_unheated =[5,2,4]

lowruns_unheated_data=np.empty(shape=(1,4))

lowruns_unheated_list = [pulled_from_bulk[i] for i in lowruns_unheated]
...
lowruns_heated =[7,2,6]

lowruns_heated_data=np.empty(shape=(1,4))


lowruns_heated_list = [match2_locations[i][2] for i in lowruns_heated]
...
highruns_unheated=[15, 10, 6]
highruns_unheated_list = [pulled_from_bulk[i] for i in highruns_unheated]
...
del highruns_unheated

highruns_heated=[18, 12, 8]

highruns_heated_list = [match2_locations[i][2] for i in highruns_heated]
