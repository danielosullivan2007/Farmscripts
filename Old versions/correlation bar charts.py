...
#ax1.yscale('log')
fig = plt.figure()
ax1 = plt.scatter(alldata.index, alldata['-15m'],color='b')
ax2 = plt.scatter(alldata.index, alldata['-15f'],color='r')

fig = plt.figure()
ax1 = plt.scatter(alldata.index, alldata['-20m'],color='b')
ax2 = plt.scatter(alldata.index, alldata['-20f'],color='r')

fig = plt.figure()
ax1 = plt.scatter(alldata.index, alldata['-25m'],color='b')
ax2 = plt.scatter(alldata.index, alldata['-25f'],color='r')